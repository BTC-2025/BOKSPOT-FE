          ...
          <div className="flex-1 space-y-8">
            ...
            <div>
              ...
              <p className="text-[color:var(--color-on-surface-variant)] text-sm leading-relaxed mb-3">
                Welcome to {venueName}, your trusted premium partner in {city || 'Chennai'}. We guarantee expert consultations, absolute hygiene, and top-tier services tailored to you.
              </p>
              <button className="text-[color:var(--color-primary)] font-bold text-sm flex items-center gap-1 hover:underline">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-y-6 gap-x-4">
                <div className="flex items-center gap-3 text-sm font-medium">
                  <Clock size={20} className="text-[color:var(--color-outline)]" /> 24/7 Check-in available
                </div>
                <div className="flex items-center gap-3 text-sm font-medium">
                  <Map size={20} className="text-[color:var(--color-outline)]" /> Parking (Free)
                </div>
                <div className="flex items-center gap-3 text-sm font-medium">
                  <Utensils size={20} className="text-[color:var(--color-outline)]" /> Washrooms available
                </div>
                <div className="flex items-center gap-3 text-sm font-medium">
                  <Users size={20} className="text-[color:var(--color-outline)]" /> Seating lounge
                </div>
              </div>
              
              <button className="mt-6 w-full flex items-center justify-between p-4 rounded-2xl border border-[color:var(--color-outline-variant)]/30 hover:bg-[color:var(--color-surface-variant)]/50 transition-colors">
                <div className="flex items-center gap-3 font-bold text-sm">
                  <Info size={20} /> Terms and Conditions
                </div>
            ...
            <div className="sticky top-24 space-y-4">
              ...
              <div className="p-4 rounded-2xl border border-[color:var(--color-outline-variant)]/30 bg-[color:var(--color-surface-variant)]/10">
                ...
                <div className="flex items-center gap-2 text-xs font-bold">
                  <Map size={14} /> View on Map • 5.2 km away
                </div>
              </div>
            </div>
          </div>
